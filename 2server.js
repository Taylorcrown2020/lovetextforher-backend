...
// ✅ FIXED: admin middleware now returns proper 401 when not logged in / invalid
...
app.get("/api/customer/subscription", authCustomer, async (req, res) => {
    ...
    res.json({ subscribed: q.rows[0].has_subscription });
});
...
// ============================================================
// ADMIN LOGIN — LOCALHOST FRIENDLY
// ============================================================
...
app.get("/api/admin/kpis", authAdmin, async (req, res) => {
    try {
        ...
        // FIXED — no JSON functions, works for ALL DBs
...
// ============================================================
// STRIPE PLACEHOLDER — KEEPING THIS FOR FUTURE INTEGRATION
// ============================================================
...
app.get("/api/customer/subscription/portal", authCustomer, async (req, res) => {
    ...
    try {
        // You would normally look this up from your DB
